...
async function regraCombustivel(chatId, client, placa, currentDate = new Date(), nome) {
    ...
    switch (true) {
        ...
        default:
            return await client.sendMessage(chatId,`${nome} Aguarde, um dos nossos operadores irá entrar em contato.`);
    }
}
